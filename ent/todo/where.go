...
import (
	...
	"github.com/miromax42/gqlgen-ent-play/ent/predicate"
)
...
func ModifiedAt(v time.Time) predicate.Todo {
	return predicate.Todo(func(s *sql.Selector) {
...
func ModifiedAtEQ(v time.Time) predicate.Todo {
	return predicate.Todo(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldModifiedAt), v))
	})
}
...
func ModifiedAtNEQ(v time.Time) predicate.Todo {
	return predicate.Todo(func(s *sql.Selector) {
...
func ModifiedAtIn(vs ...time.Time) predicate.Todo {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ModifiedAtNotIn(vs ...time.Time) predicate.Todo {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ModifiedAtGT(v time.Time) predicate.Todo {
	return predicate.Todo(func(s *sql.Selector) {
...
func ModifiedAtGTE(v time.Time) predicate.Todo {
	return predicate.Todo(func(s *sql.Selector) {
...
func ModifiedAtLT(v time.Time) predicate.Todo {
	return predicate.Todo(func(s *sql.Selector) {
...
func ModifiedAtLTE(v time.Time) predicate.Todo {
	return predicate.Todo(func(s *sql.Selector) {
