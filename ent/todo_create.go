...
func (tc *TodoCreate) SetModifiedAt(t time.Time) *TodoCreate {
	tc.mutation.SetModifiedAt(t)
	return tc
}

// SetNillableModifiedAt sets the "modified_at" field if the given value is not nil.
func (tc *TodoCreate) SetNillableModifiedAt(t *time.Time) *TodoCreate {
	if t != nil {
		tc.SetModifiedAt(*t)
	}
	return tc
...
func (tc *TodoCreate) check() error {
	...
	if _, ok := tc.mutation.ModifiedAt(); !ok {
		return &ValidationError{Name: "modified_at", err: errors.New(`ent: missing required field "Todo.modified_at"`)}
	}
	return nil
}
