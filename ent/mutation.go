...
func (m *TodoMutation) SetModifiedAt(t time.Time) {
	m.modified_at = &t
}

// ModifiedAt returns the value of the "modified_at" field in the mutation.
func (m *TodoMutation) ModifiedAt() (r time.Time, exists bool) {
	v := m.modified_at
	if v == nil {
		return
	}
...
// OldModifiedAt returns the old "modified_at" field's value of the Todo entity.
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldModifiedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *TodoMutation) ResetModifiedAt() {
	m.modified_at = nil
}
...
func (m *TodoMutation) Fields() []string {
	...
	if m.modified_at != nil {
		fields = append(fields, todo.FieldModifiedAt)
	}
	return fields
}
