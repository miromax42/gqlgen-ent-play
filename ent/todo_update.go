...
func (tu *TodoUpdate) SetModifiedAt(t time.Time) *TodoUpdate {
	tu.mutation.SetModifiedAt(t)
	return tu
}

// SetNillableModifiedAt sets the "modified_at" field if the given value is not nil.
func (tu *TodoUpdate) SetNillableModifiedAt(t *time.Time) *TodoUpdate {
	if t != nil {
		tu.SetModifiedAt(*t)
	}
	return tu
...
// SetModifiedAt sets the "modified_at" field.
func (tuo *TodoUpdateOne) SetModifiedAt(t time.Time) *TodoUpdateOne {
	tuo.mutation.SetModifiedAt(t)
	return tuo
}

// SetNillableModifiedAt sets the "modified_at" field if the given value is not nil.
func (tuo *TodoUpdateOne) SetNillableModifiedAt(t *time.Time) *TodoUpdateOne {
	if t != nil {
		tuo.SetModifiedAt(*t)
	}
	return tuo
